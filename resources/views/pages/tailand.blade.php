    ...
    <section class="wrapper pt-118px">
        ...
        <div class="info_img">
            ...
            <div class="text_info_in_page">
                ...
                <h2>Таиланде из ЛНР (вылет из г. Ростов-на-Дону).</h2> <br>
                <p>Отдых в самых популярных курортах: Паттайи и Пхукета. Таиланд – сказочное Королевство Таиланд известно всем великолепными местами для отдыха.</p>
