@extends('layouts.app')
@section('title')Выбор туров по всем странам мира из Луганска по самым низким ценам. Можно забронировать подходящий горящий тур.@endsection
@section('description')Самые актуальные цены на все направления мира! Подобрать страну для хорошего отдыха и приятных воспоминаний.@endsection
