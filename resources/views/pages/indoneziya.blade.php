...
@section('description')Купить путевку на отдых в Индонезию по самым низким ценам! Острова Нуса-Дуа,Острова Ява, Бали.@endsection
    ...
    <section class="wrapper pt-118px">
        ...
        <div class="info_img">
            ...
            <div class="text_info_in_page">
                Страна Индонезия - страна 1000 храмов и неповторимого серфа.<br>
                Бали теперь доступна при вылете из Москвы с 01.01.2019 г. Летают регулярные рейсы компании Россия.<br>
                Вас удивит неповторимая культура и природа Индонезии, вулканы, острова Ява.
                неподражаемые пляжи острова Нуса-Дуа. Весь остров пропитан мистикой и поклонениям Божествам и духам.<br>
